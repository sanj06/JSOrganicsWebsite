...
{	
	...
	out.println(" <tr><td rowspan='2' style='width:40%'><img class='zoom' src='img/"+ image+ "' style='height:400px; width:400px; transition: transform .2s;'></td><td colspan='2'> <h4 style='font-family:Comic Sans MS; font-size: 40px' >" + name + "</h4></td></tr><tr><td style='width:30%'><h5 style='font-family:Comic Sans MS; font-size: 25px' > Rs " + price + "</h5><form action='DeleteProductServlet' method='post'><input type='submit' name='deleteProduct' value='Delete Product' style=' background-color: gray; color: white;  padding: 15px 25px; text-align: center; '><input type='hidden' name='prod_id' value='" + id + "'></form></td><td style='width:30%'><p style='font-family:Comic Sans MS; font-size: 20px' >" + desc + "</p></td></tr>");
