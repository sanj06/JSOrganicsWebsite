...
<body onload="loadDoc('showproductlist.jsp', showProducts); loadDoc('showoffers.jsp', showOffers);">
	<table cellpadding="10px" cellspacing="0" style="width:100%; border:5px solid black; border-bottom:0px ">
		...
		<tr style="height: 150px">
			...
			<td colspan = "2" > <a href="#" onclick="openForm1()"><i class="fa fa-user" style="padding: 2px"></i><label style="padding: 6px; font-family: Comic Sans MS; ">Log In/Signup</label></a><br>
...
<table id="formtable">
	...
	<form action="login.jsp" method="post" name="form1"  >
		...
		<tr>
			...
			<td><input type="text" id="email" name="mailId" placeholder="Enter email address" style="color: gray; font-size: 15px"></td>
		</tr>
		...
		<tr>
			...
			<td><input type="password" id="pwd" name="password" placeholder="Enter password" style="color: gray; font-size: 15px;"></td>
		</tr>
		<tr>
...
function validate(event){
	event.preventDefault();
			var mail = document.form1.mailId.value;
...
function Search() {
  ...
  table = document.getElementById("products_anchor");
